...
import luan.passin.domain.attendee.exceptions.AttendeeAlreadyExistException;
import luan.passin.domain.attendee.exceptions.AttendeeNotFoundException;
import luan.passin.domain.checkin.CheckIn;
import luan.passin.dto.attendee.AttendeeBadgeResponseDTO;
import luan.passin.dto.attendee.AttendeeDetails;
import luan.passin.dto.attendee.AttendeesListResponseDTO;
import luan.passin.dto.attendee.AttendeeBadgeDTO;
...
public class AttendeeService {
    ...
    public AttendeeBadgeResponseDTO getAttendeeBadge(String attendeeId, UriComponentsBuilder uriComponentsBuilder){
        ...
        var uri = uriComponentsBuilder.path("/events/{attendeeId}/check-in").buildAndExpand(attendeeId).toUri().toString();
